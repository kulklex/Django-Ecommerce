...
const About = () => {
    ...
    useEffect(() => {
        ...
        const getTopSeller = async () => {
            try {
                const res = await axios.get(`${process.env.REACT_APP_API_URL}/realtors/topseller`, config);
    ...
    useEffect(() => {
        ...
        const getRealtors = async () => {
            try {
                const res = await axios.get(`${process.env.REACT_APP_API_URL}/realtors/`, config);
